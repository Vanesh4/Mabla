# Generated by Django 4.1.7 on 2023-08-03 17:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imgPerfil', models.ImageField(blank=True, default='user.png', null=True, upload_to='img/')),
                ('alias', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='Tablas.tablausuario')),
